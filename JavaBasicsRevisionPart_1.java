...
public class JavaBasicsRevisionPart_1
{
	...
	public static void main(String args[])
	{
		...
		*/
		...
		/* ---------------- Operator Precedence ---------------- /
        //Basically in an arithmatic operation with operator work first.
	...
	When there are two operators with the same precedence the expression is evaluated according to its associativity.
		...
		*/
		...
		do
		{
			...
			validYear = (year >= 1930 && year < 2019) ? true : false; // The ternary operator
